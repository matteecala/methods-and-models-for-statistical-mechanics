...
\vspace{-0.2cm}
\fontsize{0.3cm}{0.5cm}\selectfont \bfseries \textsc{\color{bluePoli} Methods and Models for Statistical Mechanics \\ \course}\\
...
\noindent \textbf{\color{bluePoli} Introduction:} {\abstract}
\end{minipage}
\end{center}
